...
public class BedwarsOverlay extends Mod {
    ...
    public static void onRenderTick() {
        ...
        Gui.drawRect(0, 30, 324, 51 + ((playersInLobby.size() != 0) ? 4 : 0) + 18 * playersInLobby.size(), new Color(0, 0, 0, 125).getRGB());
        Gui.drawRect(0, 29, 324, 30, -1); //top line
        Gui.drawRect(0, 50, 324, 51, -1); //bottom line
        Gui.drawRect(323, 29, 324, 51, -1); //fill + side line
        mc.fontRendererObj.drawString("ign", 5, 36, RenderUtils.getChroma(2L));
        ...
        for (Map.Entry<UUID, OverlayPlayer> entry : playersInLobby.entrySet()) {
            ...
            if (!player.isLoaded()) {
                mc.fontRendererObj.drawString(player.getEncountersStr() + player.getDisplayName() + "§e [NICK] ", 5, y, -1);
                ...
                mc.fontRendererObj.drawString(player.getEncountersStr() + player.getDisplayName(), 5, y, -1);
    ...
    public static void onTick() {
        ...
        while (iterator.hasNext()) {
            ...
            loadedTab.add(networkPlayer.getGameProfile().getId());
        }
        ...
        for (NetworkPlayerInfo networkPlayer : mc.getNetHandler().getPlayerInfoMap()) {
            GameProfile profile = networkPlayer.getGameProfile();
            if ((!profile.getName().contains("§") || profile.getName().startsWith("§c")) && networkPlayer.getResponseTime() != 1) {
                continue;
            }
